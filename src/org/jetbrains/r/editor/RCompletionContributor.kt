...
import org.jetbrains.r.classes.s4.extra.AtAccessCompletionProvider
import org.jetbrains.r.classes.s4.extra.S4ClassContextCompletionProvider
...
class RCompletionContributor : CompletionContributor() {
  ...
  private fun addAtAccessCompletion() {
    extend(CompletionType.BASIC, psiElement().withLanguage(RLanguage.INSTANCE)
      .and(RElementFilters.AT_ACCESS_FILTER), AtAccessCompletionProvider(rCompletionElementFactory))
  }
  ...
  private fun addS4ClassContextCompletion() {
    extend(CompletionType.BASIC, psiElement().withLanguage(RLanguage.INSTANCE)
      .and(RElementFilters.S4_CONTEXT_FILTER), S4ClassContextCompletionProvider(rCompletionElementFactory))
  }
